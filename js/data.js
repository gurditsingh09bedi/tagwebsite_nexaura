...
// Card materials — 2 groups (PVC / Metal), each with 3 color/finish
...
const COLORWAYS = [
  { id: "onyx", name: "Onyx", material: "plastic", tagline: "The original.", description: "Lightweight matte black PVC with a single cyan seam — the affordable starting point.", price: 21.00, accent: "#22D3EE", gradient: ["#1c1e22", "#0a0a0c"], sheen: "#3a3d42", photo: "https://d8j0ntlcm91z4.cloudfront.net/user_3IeTxclyM519NpjOSRitBmE65fY/hf_20260830_212555_10aafd00-370e-4f8a-a7ff-85d9bd913318.png" },
  { id: "pearl-white", name: "Pearl White", material: "plastic", tagline: "Clean, bright, unmistakable.", description: "A bright pearl-white PVC finish with a cool silver edge-light — the lightest, most eye-catching PVC option.", price: 23.99, accent: "#8a8d92", gradient: ["#e8e8ec", "#b8bac2"], sheen: "#ffffff", photo: "https://d8j0ntlcm91z4.cloudfront.net/user_3IeTxclyM519NpjOSRitBmE65fY/hf_20260830_213452_d3f37beb-89ef-4560-a92e-3e2b8dc59f7a.png" },
  { id: "imported-pattern", name: "Imported Pattern", material: "plastic", tagline: "A textured statement.", description: "An imported textured pattern finish on the same durable PVC build — for a card that stands out on sight.", price: 25.99, accent: "#E8B84B", gradient: ["#2a1f3d", "#160f24"], sheen: "#6d5a9e", photo: "https://d8j0ntlcm91z4.cloudfront.net/user_3IeTxclyM519NpjOSRitBmE65fY/hf_20260830_212528_ae7b1353-1fba-4118-809c-420d90ed2dea.png" },

  { id: "metal-black", name: "Metal Black", material: "metal", tagline: "Solid. Weighty. Serious.", description: "Solid anodized black metal — heavier and more durable than any PVC finish, with a bright silver seam.", price: 25.00, accent: "#E8ECF1", gradient: ["#1a1a1c", "#050506"], sheen: "#3d3d40", photo: "https://d8j0ntlcm91z4.cloudfront.net/user_3IeTxclyM519NpjOSRitBmE65fY/hf_20260830_212528_f982d5f7-bfbd-4c7f-8744-617a8d642490.png" },
